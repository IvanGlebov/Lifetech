...
export default class ProfileO extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      button_names: {
        ...
        5: {id: 5, name: 'создание мероприятия'},
        6: {id: 6, name: 'обратная связь'},
      },
      photos: {
        1: {id: 1, img:'https://osvitoria.media/wp-content/uploads/2020/09/cover_ed_aftercovid.jpg'},
        2: {id: 2, img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvRLAm3cEYJdIdTEw1L4VPkgFuYKaWhkOw_Q&usqp=CAU"},
        3: {id: 3, img:"https://afabrica.ru/images/masterklass/mk_corporat/b36ZWlBH4Sg.jpg"},
        4: {id: 4, img:'http://www.divadance.ru/images/imagemer/studia_tanzev_201306_kontsert_diva_dance/104_detskoe_gogo_shkolniki1.jpg'},
